"""
Django settings for floral_poetry_42931 project.
...
ROOT_URLCONF = 'floral_poetry_42931.urls'
...
WSGI_APPLICATION = 'floral_poetry_42931.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "floral_poetry_42931 API",
    "DESCRIPTION": "API documentation for floral_poetry_42931 App",
    "VERSION": "v1",
}
